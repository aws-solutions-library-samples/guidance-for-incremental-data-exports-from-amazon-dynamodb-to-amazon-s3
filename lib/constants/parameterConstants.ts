...
export class parameterConstants {
    static PARAMETER_INFO: string = 'parameterInfo';

    // Parameter names within SF outputs
    static WORKFLOW_INITATED_PARAMETER = 'workflowInitiatedParameter';
